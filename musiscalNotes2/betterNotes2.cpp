...
const int speedOfSound = 345;
double f; //the final awnswer
double dWavelengthCentimeters; //final wavelength in meters
...
std::string a_strNotes[] = {
    ...
    for (int nu = 0; nu < k_nOctaves; ++nu){ //nu == octave , k == tones
        for (int k = 0; k < k_nHalfTones; ++k){
            // this is the freqency equation
            f = refrenceFrequency * pow(2 , nu + (k/12.0));
           
            //this is the wavelength equation
