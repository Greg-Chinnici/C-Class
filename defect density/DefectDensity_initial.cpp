...
int main()
{
    ...
    try{
        ...
        std::cin >> nDefects;
        if (nDefects < 0) {
            std::string strMessage = "invalid value for number of defects: " + std::to_string(nDefects) + " must be greater than or equal to 0. " + "(File location: " + __FILE__ + ", " + std::to_string(__LINE__) + ")";
        ...
        if (nProgramUnitSize < 1) {
            std::string strMessage = "invalid value for program unit size: " + std::to_string(nProgramUnitSize) + " must be greater than or equal to 1. " + "(File location: " + __FILE__ + ", " + std::to_string(__LINE__) + ")";
        ...
        std::cout << "Cannot get defect density" << std::endl;
    }
    return 0;
}
